...
public class BasicRowProcessor implements RowProcessor {
	private static final Logger LOGGER = Logger.getLogger(BasicRowProcessor.class);	
    ...
    public Map<String, Object> toMap(ResultSet rs,List<Field> displayField) throws SQLException {
    	Map<String, Object> result = new CaseInsensitiveHashMap();
    
    	Field field = null;
    	String columnName =null;
    	for (int i = 0; i <displayField.size(); i++) {
    		field =displayField.get(i);
