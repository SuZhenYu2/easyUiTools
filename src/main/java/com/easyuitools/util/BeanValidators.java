...
public class BeanValidators {
	...
	public static void validateWithExceptionText (Validator validator, Object object, Class<?>... groups) throws Exception{
		try {
			BeanValidators.validateWithException(validator, object,groups);
			} catch (ConstraintViolationException e) {
				StringBuffer sb = new StringBuffer();
				List<String>  listStr =BeanValidators. extractMessage(e);
				if( listStr.size()>0){
